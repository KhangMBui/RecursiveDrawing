...
public class FractalDisplay extends JPanel implements MouseListener, ActionListener, ChangeListener {
	...
	//Scale MyShape
	public static final int SCALE2 = HEIGHT*20/100;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().getClass() == JRadioButton.class) {
			...
			case H_SHAPE:
				...
				shape = new HShape(0, 0, WIDTH, HEIGHT, getRandomColor());
				break;  
			case MY_SHAPE:
//				// TODO
//				// Call your MyShape constructor here
//				// Replace shape = null with shape = new MyShape(...))
				Point x = new Point(WIDTH/2, 0 + SCALE2);
				Point y = new Point(0 + SCALE2, HEIGHT-SCALE2);
				Point z = new Point(WIDTH - SCALE2, HEIGHT-SCALE2);
				shape = new SierpinskiCarpet(0, 0, WIDTH, HEIGHT, getRandomColor());
				
				
//				shape = new ShurikenShape(new Point(centerX, centerY), getRandomColor());
//				break;
			}
